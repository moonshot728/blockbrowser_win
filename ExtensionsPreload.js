...
/******/ 	return __webpack_require__(__webpack_require__.s = "./preload.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "../electron-chrome-extensions/dist/browser-action.js":
/*!************************************************************!*\
!*** ../electron-chrome-extensions/dist/browser-action.js ***!
\************************************************************/
...
onClick(event) {
this.activate(event);/*
console.log('burassssssssssssss')
console.log(event)*/
}
...
getBadge() { console.log(this.badge)
...
.action:hover {
background-color: var(--browser-action-hover-bg, rgb(208 208 208 / 26%));
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var electron_chrome_extensions_dist_browser_action__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! electron-chrome-extensions/dist/browser-action */ "../electron-chrome-extensions/dist/browser-action.js");
/* harmony import */ var electron_chrome_extensions_dist_browser_action__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(electron_chrome_extensions_dist_browser_action__WEBPACK_IMPORTED_MODULE_0__);
// Inject <browser-action-list> element into WebUI

//if (location.protocol === 'block:') {}
Object(electron_chrome_extensions_dist_browser_action__WEBPACK_IMPORTED_MODULE_0__["injectBrowserAction"])();
