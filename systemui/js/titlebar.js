...
//if(document.title == 'BLOCK Main Window') 
...
let input = { message: i18n.__('Kapatmak istediğinden emin misin')+' ' + pageNumberOnlys + ' '+i18n.__('sekme açık?'), type: 'confirm',	url: 'BLOCK' };
