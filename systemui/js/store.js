...
// var pass = v1();
// keytar.getPassword('block', 'encryptionKey').then(r => {
//   console.log(r, pass);
//   if(!r) keytar.setPassword('block', 'encryptionKey', pass);
//   else pass = r;
// });
...
history.set('app', 'block');
bookmarks.set('app', 'block');
downloads.set('app', 'block');
saveInfoXcont.set('app', 'block');
tabsPins.set('app', 'block');
sideBarLeft.set('app', 'block');
bird.set('app', 'block');
