...
var namevalueNew = '';
if(eText == "block"){ namevalueNew = i18n.__('Varsayılan Yeni Sekme'); }
if(eText == "bing"){ namevalueNew = i18n.__('BING Yeni Sekme'); }
...
if(val == "dark-pink"){ namevalueNew = i18n.__('Koyu Pembe'); }
if(val == "dark-red"){ namevalueNew = i18n.__('Koyu Kırmızı'); }
if(val == "dark-green"){ namevalueNew = i18n.__('Koyu Yeşil'); }
if(val == "dark-turquoise"){ namevalueNew = i18n.__('Koyu Turkuaz'); }
if(val == "dark-blue"){ namevalueNew = i18n.__('Koyu Mavi'); }
if(val == "dark-purple"){ namevalueNew = i18n.__('Koyu Mor'); }
...
if(intextkeys){ 
var namevalueNew = '';
if(val == "block"){ namevalueNew = i18n.__('Varsayılan Yeni Sekme'); }
if(val == "bing"){ namevalueNew = i18n.__('BING Yeni Sekme'); }
intextkeys.innerHTML = namevalueNew;
} 
}
...
getJSON('https://api.github.com/repos/cetinmert/block/releases/latest',
function(err, data) {
if (err !== null) {
